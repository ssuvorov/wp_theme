...
function noo_organici_customizer_css_generator() {
...
global $wp_customize;
if ( isset( $wp_customize ) || noo_organici_get_option('noo_use_inline_css', false) ) {
	add_action( 'wp_head', 'noo_organici_customizer_css_generator', 100, 0 );
}
