...
if ( ! class_exists( 'Noo_Organici_Check_Version' ) ) {

    class Noo_Organici_Check_Version {
        ...
        public function add_license_settings_page() {
            $title = sprintf( esc_html__( '%s License', 'noo-organici' ), $this->product_name );
        ...
        public function add_license_settings_fields() {
            ...
            add_settings_section(
                $settings_section_id,
                sprintf( noo_organici_kses( __( 'License <a target="_blank" href="%s" style="">How to get License key?</a>', 'noo-organici' ) ), 'http://support.nootheme.com/wp-content/uploads/2015/07/HowToGetPurchaseCode.png' ),
            ...
            add_settings_field(
                ...
                esc_html__( 'License e-mail or domain address', 'noo-organici' ),
            ...
            add_settings_field(
                ...
                esc_html__( 'License key', 'noo-organici' ),
        ...
        public function render_email_settings_field() {
            ...
            ?>
            <input type='text' name='<?php echo esc_attr($settings_field_name); ?>[email]'
        ...
        public function render_license_key_settings_field() {
            ...
            $options = get_option( $settings_field_name );
            ?>
            <input type='text' name='<?php echo esc_attr($settings_field_name); ?>[license_key]'
                   value='<?php echo esc_attr($options['license_key']); ?>' class='regular-text'>
        <?php
        }
        ...
        public function show_admin_notices() {
            ...
            if ( ! $options || ! isset( $options['email'] ) || ! isset( $options['license_key'] ) ||
                ...
                $msg = esc_html__( 'Please enter your license key to enable updates to %s.', 'noo-organici' );
                ...
                <div class="update-nag">
                    ...
                    <p>
                        <a href="<?php echo admin_url( 'options-general.php?page=' . $this->get_settings_page_slug() ); ?>">
                            <?php echo esc_html__( 'Complete the setup now.', 'noo-organici' ); ?>
                        </a>
                    </p>
                </div>
            <?php
